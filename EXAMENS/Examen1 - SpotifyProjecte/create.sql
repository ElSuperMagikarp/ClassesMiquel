...
CREATE TABLE ProfilesProfilesImages (
    Id UNIQUEIDENTIFIER NOT NULL PRIMARY KEY,
    ProfileId UNIQUEIDENTIFIER NOT NULL,
    ProfileImageId UNIQUEIDENTIFIER NOT NULL,
    CONSTRAINT FKProfilesProfilesImagesProfile FOREIGN KEY (ProfileId)
        REFERENCES Profiles(Id),
    CONSTRAINT FKProfilesProfilesImagesProfileImage FOREIGN KEY (ProfileImageId)
        REFERENCES ProfilesImages(Id)
);
